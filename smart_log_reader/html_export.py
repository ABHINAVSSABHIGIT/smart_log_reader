...
def get_report_dir() -> Path:
    ...
    # Enforce 700: owner rwx, group ---, others ---
...
<footer>Generated by <a href="https://github.com/ABHIRAMSS/smart-log-reader" target="_blank">smart-log-reader</a> &nbsp;·&nbsp; {total:,} entries &nbsp;·&nbsp; format: {fmt}</footer>
</div>
...
document.getElementById('gen-ts').textContent=new Date().toLocaleString();
    ...
    # Write with restrictive permissions: owner rw only (600)
...
def serve_html(html_path: Path, port: int = 0, public: bool = False) -> None:
    ...
    class Handler(http.server.SimpleHTTPRequestHandler):
        ...
        def log_message(self, *_):
            pass   # silence per-request noise in the terminal
